...
pygame.display.set_caption("20201914 Park Jihyun Shmup!")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(player_img, (98, 50))
...
meteor_list = ['meteor_big1.png', 'meteor_big2.png', 'meteor_big3.png',
               'meteor_med1.png', 'meteor_med2.png',
...
explosion_anim['sm'] = []
for i in range(9):
    filename = 'expl_01_0{}.png'.format(i)
...
shoot_sound = pygame.mixer.Sound(path.join(snd_dir, 'alienshoot.wav'))
expl_sounds = []
